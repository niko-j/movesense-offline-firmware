...
constexpr uint8_t SENSOR_PROTOCOL_VERSION_MINOR = 3;

constexpr uint16_t SENSOR_MEAS_OFF = 0;
constexpr uint16_t SENSOR_MEAS_ON = 1;
constexpr uint16_t SENSOR_MEAS_SAMPLERATES_ECG[] = { SENSOR_MEAS_OFF, 125, 128, 200, 250, 256 };
constexpr uint16_t SENSOR_MEAS_SAMPLERATES_IMU[] = { SENSOR_MEAS_OFF, 13, 26, 52, 104, 208 };
constexpr uint16_t SENSOR_MEAS_TOGGLE[] = { SENSOR_MEAS_OFF, SENSOR_MEAS_ON };
constexpr uint16_t SENSOR_MEAS_PRESETS_INTERVALS[] = { SENSOR_MEAS_OFF, 1, 30, 60, 300, 900, 1800, 3600 };
